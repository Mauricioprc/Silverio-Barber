...
import { clientesPublicoRoutes } from "./modules/clientes/clientes-publico.routes";
...
import { verificacaoRoutes } from "./modules/verificacao/verificacao.routes";
...
app.route("/api/publico/clientes/verificacao", verificacaoRoutes);
app.route("/api/publico/clientes", clientesPublicoRoutes);
app.route("/api/publico", publicoRoutes);
app.route("/api/interno/lembretes", lembretesRoutes);
